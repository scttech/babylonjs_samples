...
const createScene = () => {
  ...
  // True once lives reach 0 -- gates paddle input and the physics/collision
  // step below so nothing moves until Reset is clicked.
  let gameOver = false;
  ...
  scene.onBeforeRenderObservable.add(() => {
    ...
    // Sparks still finish animating out even while frozen on Game Over.
